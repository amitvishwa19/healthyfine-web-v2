...
const frameworkOptions = [
    ...
    { id: '5', value: "nextjs", label: "Next.js" },
    { id: '6', value: "nuxt", label: "Nuxt" },
    { id: '7', value: "remix", label: "Remix" },
    { id: '8', value: "astro", label: "Astro" },
];

export default function NewContentPage({ post, onSave, onCancel }) {
        ...
        <div className='absolute inset-0 flex flex-col gap-2 p-2'>
            ...
            <div className='w-full dark:bg-darkSecondaryBackground  p-4 rounded-md border flex flex-row items-center justify-between'>
                ...
                <div className="flex gap-3">
                    <Button variant="outline" disabled={loading} size='sm' onClick={() => setContentCreator(!contentCreator)} className="gap-2"                    >
                        <Sparkles className='' />
                        Generate with AI
                    </Button>
            ...
            <AIPostGenerator setOpen={contentCreator} handleClose={setContentCreator} />
        </div >
    )
}
