...
export default function NewAppointmentManager() {
                                                ...
                                                {(doctor?.setting?.timing ?? hospitalDefaultSettings?.timing)?.map((item, index) => {
                                                    ...
                                                    return (
                                                        ...
                                                        <Button
                                                            ...
                                                            className={`flex flex-col p-4 h-12 md:h-16 
                                                        ...
                                                        return (
                                                            <div key={index}>
                                                                <Button
                                                                    ...
                                                                    disabled={isDisabled}
                                                                    className={cn(
                                                                        "border w-20 hover:ring-[0.8px] bg-primary/20 dark:bg-darkFocusColor/60  flex-1 mx-1",
                                                                        isActive && "bg-primary/30 dark:bg-darkFocusColor ring-[0.8px]",
