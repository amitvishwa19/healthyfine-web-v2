...
export default function AppointmentCalenderPage() {
    ...
    const renderDays = () => {
        ...
        for (let i = 0; i < totalCells; i++) {
            ...
            const appointments = isValidDay ? mockAppointments[dateKey] || [] : [];
        ...
        return (
            <div className="grid grid-cols-7 gap-2 h-full w-full p-2">
                {weekDays.map((day, idx) => {
                    ...
                    return (
                        <Card key={idx} className={cn("p-3 overflow-auto dark:bg-darkFocusColor border", isToday && "ring-[0.5px] ring-primary")}>
